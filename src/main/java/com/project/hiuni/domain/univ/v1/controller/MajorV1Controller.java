...
public class MajorV1Controller {
  ...
  public List<Major> findMajorsByUnivName(@RequestParam("keyword") String keyword, @PathVariable String univName) {
    ...
    return majorV1Service.findMajorsByUnivName(univName, keyword);
  }
